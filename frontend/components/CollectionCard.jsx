...
var ILLUSTRATION_MAP = {
  "구상나무":    "/assets/illustrations/구상나무.png",
  "황소개구리":  "/assets/illustrations/황소개구리.png",
  "왜가리":      "/assets/illustrations/왜가리.png",
  "소나무":      "/assets/illustrations/소나무.png",
  "참나무":      "/assets/illustrations/참나무.png",
  "은행나무":    "/assets/illustrations/은행나무.png",
  "진달래":      "/assets/illustrations/진달래.png",
  "개나리":      "/assets/illustrations/개나리.png",
  "철쭉":        "/assets/illustrations/철쭉.png",
  "무궁화":      "/assets/illustrations/무궁화.png",
  "반달가슴곰":  "/assets/illustrations/반달가슴곰.png",
  "수달":        "/assets/illustrations/수달.png",
  "삵":          "/assets/illustrations/삵.png",
  "두루미":      "/assets/illustrations/두루미.png",
  "황새":        "/assets/illustrations/황새.png",
  "따오기":      "/assets/illustrations/따오기.png",
  "수리부엉이":  "/assets/illustrations/수리부엉이.png",
  "참수리":      "/assets/illustrations/참수리.png",
  "꽃사슴":      "/assets/illustrations/꽃사슴.png",
  "고라니":      "/assets/illustrations/고라니.png",
  "너구리":      "/assets/illustrations/너구리.png",
  "맹꽁이":      "/assets/illustrations/맹꽁이.png",
  "금개구리":    "/assets/illustrations/금개구리.png",
  "꼬치동자개":  "/assets/illustrations/꼬치동자개.png",
  "미호종개":    "/assets/illustrations/미호종개.png",
  "분홍바늘꽃":  "/assets/illustrations/분홍바늘꽃.png",
  "한라솜다리":  "/assets/illustrations/한라솜다리.png",
};

var FALLBACK_IMG = "/assets/illustrations/fallback.png";
